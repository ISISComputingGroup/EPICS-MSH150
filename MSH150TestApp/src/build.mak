...
#=============================
# Build the IOC application MSH150Test
# We actually use $(APPNAME) below so this file can be included by multiple IOCs

PROD_IOC = $(APPNAME)
# MSH150Test.dbd will be created and installed
DBD += $(APPNAME).dbd

# MSH150Test.dbd will be made up from these files:
$(APPNAME)_DBD += base.dbd
$(APPNAME)_DBD += asyn.dbd
$(APPNAME)_DBD += MSH150.dbd
